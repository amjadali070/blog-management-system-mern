...
const schema = yup.object({
    ...
    role: yup.string().oneOf(['author', 'admin'], 'Invalid role').required('Role is required'),
});
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                {...register('role')}
                                className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.role ? 'border-red-300' : 'border-gray-300'
                                    }`}
                            >
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    autoComplete="new-password"
                                    className={`block w-full px-3 py-2 pr-10 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.confirmPassword ? 'border-red-300' : 'border-gray-300'
                                        }`}
